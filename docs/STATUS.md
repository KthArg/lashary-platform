...
| auth | pendiente | en_progreso | 0 / 2 / 0 / 0 / 0 |
...
- US-AUTH-01 — en_progreso — falta: Implementar invocación de guardia en middleware para protección de rutas (CA-4) y timeout de inactividad de sesión (CA-5)
