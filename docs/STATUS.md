...
- US-LAND-07 — en_progreso — falta: contrato v1.5 y lectura en content (getContact) hechos; falta las secciones Preguntas y Ubicacion, el pie de pagina, la navegacion y sus pruebas de componente para los criterios 1, 2, 3 y 5
