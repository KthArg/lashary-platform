...
- US-LAND-05 — en_progreso — falta: contrato v1.4 y lectura en content (getLoyalty) hechos; falta la seccion Fidelidad en la landing, montarla, la navegacion y sus pruebas de componente para el criterio 1
