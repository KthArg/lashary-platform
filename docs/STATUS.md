...
| landing | pendiente | en_progreso | 3 / 1 / 0 / 0 / 2 |
...
- US-LAND-04 — en_progreso — falta: contrato v1.3, lectura en content (getStudio) y la seccion El estudio (ui/LandingStudio.tsx) hechos; falta Por que aca, montar las dos secciones en la pagina y agregar El estudio a la navegacion (criterio 4)
