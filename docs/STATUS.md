...
- US-PROD-01 — en_progreso — falta: formulario de creación/edición (ui/package-form.tsx) y su cableado en AdminPackagesPage (?new/?edit); el listado, la ruta /admin/catalog/packages y el link de navegación ya están. Tests de integración/RLS escritos, pendientes de correr contra Supabase local (sin Docker en el entorno de quien los escribió)
