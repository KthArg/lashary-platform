...
| landing | pendiente | en_progreso | 2 / 1 / 0 / 0 / 3 |
...
- US-LAND-03 — en_progreso — falta: contrato v1.2, lectura en content y la seccion con su cuadricula y filtro (ui/LandingGallery.tsx, ui/GalleryGrid.tsx) hechos; falta la galeria ampliada, montar la seccion en la pagina y agregarla a la navegacion
