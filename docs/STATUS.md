...
| landing | pendiente | en_progreso | 4 / 1 / 0 / 0 / 1 |
...
- US-LAND-05 — en_progreso — falta: contrato v1.4 escrito (fidelidad y niveles-fidelidad, provisional hasta US-LAND-06); falta la lectura en content, la seccion Fidelidad en la landing, la navegacion y sus pruebas para los criterios 1 y 2
