...
// Chequeo "amable" de rol para los server actions (SEC-001): la autorización real la hacen las
// políticas RLS payments_deposit_exemptions_*_staff. Esto solo evita una llamada perdida y da un
