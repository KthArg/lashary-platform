...
historias:
  ...
  - id: US-LAND-04
    estado: en_progreso
    falta: "contrato v1.3 escrito (about, credenciales y razones); falta la lectura en content, las secciones El estudio y Por que aca en la landing, la navegacion y sus pruebas para los criterios 1 a 4"
  - id: US-LAND-05
    estado: no_iniciada
  - id: US-LAND-07
    estado: no_iniciada
