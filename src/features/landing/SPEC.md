...
historias:
  ...
  - id: US-LAND-04
    estado: en_progreso
    falta: "contrato v1.3 y validacion en content (get-studio) hechos; falta la fuente con cache y el entry point en content, las secciones El estudio y Por que aca en la landing, la navegacion y sus pruebas"
  - id: US-LAND-05
    estado: no_iniciada
  - id: US-LAND-07
    estado: no_iniciada
