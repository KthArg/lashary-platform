...
historias:
  ...
  - id: US-LAND-04
    estado: en_progreso
    falta: "contrato v1.3 y lectura en content (getStudio) hechos; falta las secciones El estudio y Por que aca en la landing, la navegacion y sus pruebas de componente para los criterios 1, 2 y 4"
  - id: US-LAND-05
    estado: no_iniciada
  - id: US-LAND-07
    estado: no_iniciada
