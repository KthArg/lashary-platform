...
- Tipos: `StudioContent`, `StudioProfile`, `Credential`, `CredentialKind`, `Reason`, `GalleryPair`, `GalleryFamily`, `LandingContent`, `HeroContent`, `IntroContent`, `ClosingCtaContent`, `CmsImage`.
