export const clientsListStyles = {
  ...
  headerCellActions: 'border-y border-brand-border/60 py-2 text-right text-xs font-normal uppercase tracking-widest text-brand-muted',
  ...
  error: 'mt-4 flex flex-wrap items-center justify-between gap-4 p-3 bg-red-50 border border-red-200 text-error text-sm',
  retryButton:
    'bg-white border border-brand-border px-4 py-2 text-xs tracking-widest uppercase text-brand-dark cursor-pointer transition-colors hover:border-brand-gold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-dark',
}
