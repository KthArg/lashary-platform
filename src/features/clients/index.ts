...
export { CLIENTS_LABELS, CLIENTS_BUTTON_TEXTS, CLIENTS_ERROR_MESSAGES, CLIENTS_PLACEHOLDERS, CLIENTS_CONFIRM_MESSAGES, CLIENTS_ARIA_LABELS, CLIENTS_TABLE_HEADERS, CLIENTS_TABLE_TEXTS, CLIENTS_PAGINATION_TEXTS } from './constants/clients-strings'
