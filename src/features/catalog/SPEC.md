...
historias:
  ...
  - id: US-PROD-01
    estado: en_progreso
    falta: "db/UI de paquetes y sus políticas RLS de escritura; hasta ahora existen la migración de solo lectura, la entidad de dominio Package y application/ completo (queries + commands) contra repositorios en memoria — falta la implementación Supabase (PackageRepository) y la UI admin"
  - id: US-PROM-01
    estado: no_iniciada
  - id: US-PROM-02
    estado: no_iniciada
