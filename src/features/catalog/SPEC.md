...
historias:
  ...
  - id: US-PROD-01
    estado: en_progreso
    falta: "formulario de creación/edición (ui/package-form.tsx) y su cableado en AdminPackagesPage (?new/?edit); el listado, la ruta /admin/catalog/packages y el link de navegación ya están. Tests de integración/RLS escritos, pendientes de correr contra Supabase local (sin Docker en el entorno de quien los escribió)"
  - id: US-PROM-01
    estado: no_iniciada
  - id: US-PROM-02
    estado: no_iniciada
