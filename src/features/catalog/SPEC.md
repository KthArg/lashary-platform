...
historias:
  ...
  - id: US-PROD-01
    estado: en_progreso
    falta: "correr los tests de integración/RLS contra Supabase local (sin Docker en el entorno de quien los escribió) antes de cerrar como terminada; el resto — dominio, application, db, RLS, server actions, UI completa con formulario — ya está"
  - id: US-PROM-01
    estado: no_iniciada
  - id: US-PROM-02
    estado: no_iniciada
